...
async def encc(e):
    try:
        ...
        cmd = f'ffmpeg -i "{dl}" -preset ultrafast -c:v libx264 -s 1920x1080 -x264-params 'bframes=8:psy-rd=1:ref=3:aq-mode=3:aq-strength=0.8:deblock=1,1' -pix_fmt yuv420p -crf 30 -c:a aac -b:a 32k -c:s copy -map 0 -ac 2 -ab 32k -vbr 2 -level 3.1 -threads 1
        process = await asyncio.create_subprocess_shell(
